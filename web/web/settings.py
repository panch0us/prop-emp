...
# Абсолютный путь к каталогу, в которум будут собираться статические файлы уже во впремя деплоя проекта.
# Файлы собираются командой python3 manage.py collectstatic
